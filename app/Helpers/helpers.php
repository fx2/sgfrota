...
if (! function_exists('decimalSimples')) {
    ...
    const VEICULORESERVASAIDA_VISUALIZAR = 61;
    const VEICULORESERVASAIDA_ADICIONAR = 62;
    const VEICULORESERVASAIDA_EDITAR = 63;
    const VEICULORESERVASAIDA_DELETAR = 64;
    const VEICULORESERVASAIDA_RELATORIO = 65;
